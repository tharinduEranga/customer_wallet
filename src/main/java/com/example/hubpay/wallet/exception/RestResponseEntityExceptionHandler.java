package com.example.hubpay.wallet.exception;

import com.example.hubpay.wallet.api.response.error.Error;
import com.example.hubpay.wallet.api.response.error.ErrorResponse;
